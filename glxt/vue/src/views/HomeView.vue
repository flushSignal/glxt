<template>
    <div style="height: 100%">
        <el-container style="height: 100%; border: 1px solid #eee">
            ...
            height: 100%;box-shadow: 2px 0 6px rgb(0 21 41/35%);border-right-color:transparent" >
                <el-menu :default-openeds="['1', '3']" style="height: 100%;min-height: 100%;overflow-x: hidden"
                ...
                >
                    <div style="height: 60px; line-height: 60px; text-align: center">
                        ...
                        <b style="color: white" v-show=!isCollapse>精神管理系统</b>
                    </div>
                    <el-submenu index="1">
                        <template slot="title">
            ...
            <el-container>
                ...
                <el-main>
                    ...
                    <div style=" margin: 10px 0">
                        <el-input style="width: 200px" placeholder="请输入名称" suffix-icon="el-icon-search" v-model="input"></el-input>
